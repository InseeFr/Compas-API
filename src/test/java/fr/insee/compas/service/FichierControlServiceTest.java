...
class FichierControlServiceTest {
    ...
    void testIsFileDejaRecu_true() {
        ...
        when(tableFaitsRepository.countGreenItValuesByDate(
                ...
                .thenReturn(5);
        final boolean result = fichierControlService.isFileVmDejaRecu(date);
        assertTrue(result);
    }
    ...
    void testValidFileName() {
        assertTrue(fichierControlService.isValidVmFileName("vm-metrique-20240327.csv"));
    }

    @Test
    void testNullFileName() {
        assertFalse(fichierControlService.isValidVmFileName(null));
    }

    @Test
    void testInvalidPrefix() {
        assertFalse(fichierControlService.isValidVmFileName("document-20240327.csv"));
    }

    @Test
    void testMissingDate() {
        assertFalse(fichierControlService.isValidVmFileName("vm-metrique-.csv"));
    }

    @Test
    void testShortDate() {
        assertFalse(fichierControlService.isValidVmFileName("vm-metrique-202403.csv"));
    }

    @Test
    void testWrongExtension() {
        assertFalse(fichierControlService.isValidVmFileName("vm-metrique-20240327.txt"));
    }

    @Test
    void testExtraCharacters() {
        assertFalse(fichierControlService.isValidVmFileName("vm-metrique-20240327-final.csv"));
    }

    @Test
    void testEmptyFileName() {
        assertFalse(fichierControlService.isValidVmFileName(""));
    }
    ...
    void testControlFileName_Success() {
        ...
        assertThat(fichierControlService.controlVmFileName(validFileName))
                .isEqualTo(LocalDate.of(2024, 1, 1));
    }

    @Test
    void testControlVmFileName_InvalidFileName() {
        ...
        final CompasUploadException exception =
                assertThrows(
                        CompasUploadException.class,
                        () -> {
                            fichierControlService.controlVmFileName(invalidFileName);
                        });
        final SoftAssertions softAssertions = new SoftAssertions();
        softAssertions.assertThat(exception.getStatus()).isEqualTo(422);
        softAssertions.assertThat(exception.getErrorVM()).isNotNull();
    ...
    @Test
    void testControlKubeFileName_InvalidDate() {
        final String invalidDateFile = "kube-metrique-xxxxxx.csv";

        final CompasUploadException exception =
                assertThrows(
                        CompasUploadException.class,
                        () -> {
                            fichierControlService.controlKubeFileName(invalidDateFile);
                        });
        final SoftAssertions softAssertions = new SoftAssertions();
        softAssertions.assertThat(exception.getStatus()).isEqualTo(422);
        softAssertions.assertThat(exception.getErrorVM()).isNotNull();
    ...
    @Test
    void testControlVmFileName_InvalidDate() {
        ...
        final CompasUploadException exception =
                assertThrows(
                        CompasUploadException.class,
                        () -> {
                            fichierControlService.controlVmFileName(invalidDateFile);
                        });
        final SoftAssertions softAssertions = new SoftAssertions();
        softAssertions.assertThat(exception.getStatus()).isEqualTo(422);
        softAssertions.assertThat(exception.getErrorVM()).isNotNull();
    ...
    @Test
    void testControlVmFileName_FileAlreadyReceived() {
        final String validFileName = "vm-metrique-20240101.csv";
        when(tableFaitsRepository.countGreenItValuesByDate(
        ...
        final CompasUploadException exception =
                assertThrows(
                        CompasUploadException.class,
                        () -> {
                            fichierControlService.controlVmFileName(validFileName);
                        });
        final SoftAssertions softAssertions = new SoftAssertions();
    ...
    @Test
    void testControlKubeFileName_FileAlreadyReceived() {
        final String validFileName = "kube-metrique-20240101.csv";
        when(tableFaitsRepository.countGreenItValuesByDate(
                        LocalDate.of(2024, 1, 1), IndicateurType.CPU_CONSOMMEE.getValue()))
                .thenReturn(1);
        final CompasUploadException exception =
                assertThrows(
                        CompasUploadException.class,
                        () -> {
                            fichierControlService.controlKubeFileName(validFileName);
                        });
        final SoftAssertions softAssertions = new SoftAssertions();
        softAssertions.assertThat(exception.getStatus()).isEqualTo(400);
        softAssertions.assertThat(exception.getErrorVM()).isNotNull();
